      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 pt-12 flex flex-col">
        ...
        {step === 6 && (
          <QuestionWrapper stepNum={6} title="가장 기억에 남는 생성물이나 프로젝트가 있다면 간단히 적어주세요." subtitle="* 코딩이나 API 활용 경험이 있는 분들을 위한 질문입니다.">
            <textarea rows="6" placeholder="예: 과제용 파이썬 크롤러 작성 등..." value={answers.q6} onChange={(e) => handleTextChange('q6', e.target.value)} className="w-full bg-slate-900 border border-slate-800 rounded-2xl p-4 text-slate-200 focus:outline-none focus:border-indigo-500 resize-none" />
          </QuestionWrapper>
        )}
